...
def test_all_regions_top_and_bottom():
    ...
    assert [r["route_short_name"] for r in stats["bottom_routes"]] == ["G", "F", "E", "D", "C"]
...
def test_small_n_returns_available_routes_without_padding():
    ...
    assert len(stats["bottom_routes"]) == 2
