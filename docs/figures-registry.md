...
| ST-038 | ps2 (evening extension) CO2 saving | 112.0 t/yr | ✅ Confirmed | 04f_policy_synthesis.ipynb / lsoa_economic_appraisal.parquet (modal_shift_co2_net_saving_kg) | Sum of modal_shift_co2_net_saving_kg over the 5,189 evening-isolated LSOAs / 1000, same methodology and source column as ps1 (row A). |
| ST-039 | ps3 (DRT rural elderly) CO2 saving | 327.0 t/yr | ✅ Confirmed | 04f_policy_synthesis.ipynb / lsoa_economic_appraisal.parquet (modal_shift_co2_net_saving_kg) | Sum of modal_shift_co2_net_saving_kg over the 3,192 rural-elderly LSOAs (ST-037 scope) / 1000, same methodology and source column as ps1 (row A). |
