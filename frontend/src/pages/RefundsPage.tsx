    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="border-b border-border bg-card/50">
        <div className="max-w-4xl mx-auto px-4 flex items-center h-8">
          <span className="text-[11px] font-mono text-muted-foreground uppercase tracking-widest">Refunds Policy</span>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <span className="text-[11px] font-mono uppercase tracking-[0.2em] text-indigo-400 font-medium">Refunds Policy</span>
        ...
        <p className="text-xs text-muted-foreground leading-relaxed mt-10">
          Questions about billing: <a href={`mailto:${SUPPORT_EMAIL}`} className="text-indigo-400 hover:underline">{SUPPORT_EMAIL}</a>
        </p>
      </div>
    </div>
  )
