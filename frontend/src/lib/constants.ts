...
export const IRELAND_DIMENSIONS: DimensionDef[] = [
  ...
  { id: "economy", name: "Economy", route: "/economy", prefixes: ["j"], headlineSection: "j2_bcr", headlineStatKey: "people_gap", description: "People-gap. No published CAF €." },
...
export const NETHERLANDS_DIMENSIONS: DimensionDef[] = [
  ...
  { id: "economy", name: "Economy", route: "/economy", prefixes: ["j"], headlineSection: "j2_bcr", headlineStatKey: "people_gap", description: "People-gap. No published MKBA €." },
  { id: "policy", name: "Concession / OV-wet", route: "/policy", prefixes: ["bsa"], headlineSection: "bsa1_franchising_readiness", headlineStatKey: "national_avg", description: "OV-wet and provincie concessies" },
...
export const FRANCE_DIMENSIONS: DimensionDef[] = [
  ...
  { id: "economy", name: "Economy", route: "/economy", prefixes: ["j"], headlineSection: "j2_bcr", headlineStatKey: "people_gap", description: "People-gap. No published Quinet €." },
  { id: "policy", name: "LOM / AOM / SPC", route: "/policy", prefixes: ["bsa"], headlineSection: "bsa1_franchising_readiness", headlineStatKey: "national_avg", description: "LOM, AOM, and SPC" },
