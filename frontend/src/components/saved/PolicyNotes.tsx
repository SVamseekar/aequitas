    ...
    <div>
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-mono bg-primary text-white rounded hover:bg-primary/90 transition-colors"
        >
      ...
      {adding && (
        <div className="app-glass-strong border border-primary/25 rounded-2xl p-4 mb-4 space-y-3">
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-3 py-2 text-xs bg-muted/50 border border-border rounded font-mono text-foreground placeholder:text-muted-foreground/40 resize-none focus:outline-none focus:border-primary/40"
          />
          <div className="flex gap-2">
            <button
              onClick={() => void handleCreate()}
              className="px-3 py-1.5 text-xs font-mono bg-primary text-white rounded hover:bg-primary/90 transition-colors"
            >
              SAVE
            </button>
            <button
      ...
      {notes.length === 0 && !adding ? (
        ...
        <div className="space-y-2">
          {notes.map((n) => (
            <div key={n.id} className="app-glass-strong rounded-2xl border border-white/60 p-4">
