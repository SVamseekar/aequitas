...
const CAPS = [
  {
    ...
    img: "/landing/hero-stop.jpg",
    alt: "People waiting at a city bus stop",
  },
  {
    id: "compare",
  ...
  },
  {
    ...
    href: "/about",
    img: "/landing/hero-studio.jpg",
    alt: "Planners around a printed network map",
  },
] as const
